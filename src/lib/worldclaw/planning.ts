...
import type { ObjectRequirement, RegionSpec, ScenePlan, SceneTheme, VisualStyle } from "./types";
...
const TEMPLATES: ThemeTemplate[] = [
  {
    ...
    keywords: ["pirate", "tropical", "island", "one piece", "coastal", "palm", "dock", "ship"],
    regions: [
      {
        name: "Open Ocean",
        category: "ocean",
  ...
  },
  {
    ...
    terrainAssets: ["sparse cacti", "cover rocks", "compound yards"],
    objects: {
      "West Compound": [
        {
          category: "building",
          count: 5,
          appearance:
            "Sand-colored adobe and stone compound with flat roofs, courtyard walls, and desert plaster",
        },
        { category: "bunker", count: 2, appearance: "Low concrete desert bunker with firing slots" },
        { category: "watchtower", count: 1 },
        { category: "vehicle", count: 3, appearance: "Staged in a compound vehicle yard" },
        { category: "crate", count: 4 },
      ],
      "East Compound": [
        {
          ...
          count: 3,
          appearance:
            "Sand-colored comms compound with flat roofs, dish mounts, and desert plaster",
        },
        { category: "antenna", count: 1 },
        { category: "tank", count: 2, appearance: "Parked in a compound staging yard" },
        { category: "watchtower", count: 1 },
        { category: "crate", count: 3 },
      ],
      "Central Ruin": [
        {
          category: "building",
          count: 1,
          appearance: "Single ruined desert blockhouse as mid-map cover",
        },
        { category: "crate", count: 2 },
      ],
      "Open Dunes": [
        { category: "cactus", count: 5 },
        { category: "rock", count: 6 },
      ],
      "North Ridges": [
      ...
      "South Mesa": [{ category: "boulder", count: 4 }],
      "Rocky Scree": [{ category: "rock", count: 5 }],
    },
    mainObjects: ["compounds", "vehicles", "bunkers", "cacti"],
    spatialNotes: [
      "Broad open combat flats between west and east compounds",
      "Vehicles stay in compound staging yards",
      "Sparse cactus and rock cover only; keep long sightlines",
    ],
  },
  {
    theme: "snow",
      ...
      "Harbor Town": [
        {
          ...
          count: 7,
          appearance:
            "Japanese houses with exposed dark timber frames, white lime plaster infill, recessed wooden doors and lattice windows, and overlapping dark charcoal tile roofs",
        },
        {
          category: "pagoda",
          count: 1,
          appearance:
            "three-tier Japanese pagoda with dark timber, white plaster and deep charcoal tile eaves",
        },
        { category: "dock", count: 2 },
        { category: "boat", count: 3 },
        { category: "market", count: 2 },
      ...
      "Hill Shrine": [
        {
          category: "torii",
          count: 3,
          appearance: "vermilion Myojin torii gates with curved kasagi and stone footings",
        },
        {
          category: "pagoda",
          count: 1,
          appearance: "three-tier Japanese pagoda with deep tile eaves and a tall finial",
        },
      ...
      "Bamboo Forest": [
        {
          ...
          count: 22,
          appearance:
            "Japanese bamboo clusters with multiple segmented green culms, visible nodes and narrow lance leaves",
        },
        {
          category: "tree",
          count: 10,
          appearance:
            "Japanese cherry blossom trees with branching trunks and cloud-like pale pink blossom canopies",
        },
      ],
      Beach: [
        { category: "boat", count: 2 },
        { category: "rock", count: 6 },
      ],
      "Inland Hills": [
        { category: "tree", count: 10 },
        {
          ...
          count: 2,
          appearance:
            "Japanese houses with exposed timber frame, white plaster infill and dark overlapping roof tiles",
        },
      ],
    },
...
export function planScene(prompt: string): ScenePlan {
  ...
  return {
    ...
    mainObjects: [...new Set([...best.mainObjects, ...intent.explicitObjects])],
  };
}
